...
- Prétexte pour parler des LLMs et de la représentation sémantique
- Et mettre la main à la pâte (en Python)
...
[Qui a déjà fait du topic modeling ? Qui a de l'expérience avec les méthodes de NLP ? ]{.large-center}

. . .

[Qui a des notions en Python ?]{.large-center}

. . .

[Qui est à l'aise avec un notebook ?]{.large-center}

. . .

[Avez-vous déjà en tête des objectifs ?]{.large-center}
...
[Cas d'étude de la séance]{.highlight}: 

[Identifier les principaux thèmes de recherche à partir des résumés de thèses défendues en France.]{.large-center}
...
- [Exploratoire]{.highlight} : avoir une vision générale de son corpus (surtout quand il est large), identifier les outlayers, mieux anticiper le filtrage, ...
    - [Bizel-Bizellot, Gaston, Simon Galmiche, Benoît Lelandais, et al. 2025. « Extracting Circumstances of Covid-19 Transmission from Free Text with Large Language Models ». Nature Communications 16 (1): 5836.](https://doi.org/10.1038/s41467-025-60762-w.)
- [En cours d'analyse]{.highlight} : sélectionner une diversité de source, avoir des catégories pour annoter ses éléments
    - [Raman, Raghu, et al. 2024. « Unveiling the Dynamics of AI Applications: A Review of Reviews Using Scientometrics and BERTopic Modeling ». Journal of Innovation & Knowledge 9 (3): 100517.](https://doi.org/10.1016/j.jik.2024.100517)
- [Confirmatoire]{.highlight}
...
1. **Obtenir le notebook**
    ...
    - Si vous travaillez sur Colab: se rendre sur [https://shorturl.at/7Q3c2](https://shorturl.at/7Q3c2)
    - Si SSPCloud, créez un compte puis un service et téléverser le notebook.
2. **Obtenir les données**<br/>
    - se rendre sur la page Zenodo [https://shorturl.at/UxKAk](https://shorturl.at/UxKAk)
    - Télécharger le fichier: `embeddings.zip`
...
_Nouveau notebook avance: [https://shorturl.at/3lko9](https://shorturl.at/3lko9)_
